package FriendReducer::Web;
use strict;
use warnings;
use utf8;
use parent qw/FriendReducer Amon2::Web/;
use File::Spec;

# dispatcher
use FriendReducer::Web::Dispatcher;
sub dispatch {
    return FriendReducer::Web::Dispatcher->dispatch($_[0]) or die "response is not generated";
}
